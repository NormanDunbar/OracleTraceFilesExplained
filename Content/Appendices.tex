...
If you see a character set code in the \inline{csi} field, and you don't have the above list, you can determine the character set in use with the following query:
...
Correspondingly, you can go from a character set name to its \inline{csi} code with the following query:
